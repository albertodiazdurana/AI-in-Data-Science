...
The waterfall plots tell individual stories. A 61-year-old male with oldpeak=4 and exercise angina was correctly predicted as disease (f(x)=0.91), with every major feature contributing in the same direction. A 71-year-old female with no exercise angina was correctly predicted as no disease (f(x)=0.465), despite age and oldpeak pushing toward disease, because being female and having no exercise angina were strong enough protective factors.
